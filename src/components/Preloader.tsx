...
export function Preloader() {
  ...
  return (
    <div
      className={`fixed inset-0 z-[9999] bg-black flex items-center justify-center transition-all duration-500 ease-[cubic-bezier(0.87,0,0.13,1)]
      ${stage >= 3 ? '-translate-y-full opacity-0 pointer-events-none' : 'translate-y-0 opacity-100'}`}
    >
      <div className="flex items-center gap-4 text-white text-3xl md:text-5xl font-bold tracking-tight">
        <div
          className={`bg-white rounded-full transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]
